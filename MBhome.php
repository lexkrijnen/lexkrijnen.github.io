...
<!--
		...
		<div class="row">
			<p class="col-xs-10 col-xs-offset-1 paragraphleft page-box">
				...
				<titel>Ons bedrijf</titel><br><br><blockquote> Wij heten u van harte welkom op de site van Metselbedrijf Wegro bv.
				...
				<br><br> U kunt op onderstaande ‘link’ klikken voor het aanvragen van een vrijblijvende prijsopgave. Wanneer u al uw gegevens heeft ingevuld en een korte omschrijving van de betreffende bouwplannen heeft gemaakt dan zullen wij zo spoedig mogelijk contact met u opnemen!</blockquote><br><br>
			</p>
		</div>
