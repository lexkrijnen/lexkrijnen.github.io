        ...
        <div class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 b ">
            ...
            if ($formsubmit == TRUE){
                if ($verzonden == TRUE) { //check of het bericht is verzonden en geef hiervan een melding als het bericht verzonden is
                    ...
                    print('<div class="alert alert-warning"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Uw bericht is nog niet verzonden, vul alstublieft de Captcha in.</div>' / $_POST["naam"]);
