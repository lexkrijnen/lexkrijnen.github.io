    	...
    	<div class="row MBhomeRow">
    		<div class="col-xs-12 MBhomeBackground">
				...
				<div class="col-xs-12 MBhomeContent">
					<img class="col-xs-8 col-xs-offset-2 col-md-4 col-md-offset-4 logo" src="images/Lbouwbedrijf-Wegro.png">
		...
		<div class="row">
			<div class="col-xs-10 col-xs-offset-1 col-md-12 col-md-offset-0 paragraphleft page-box">
				...
				<p>
					...
					<br><br>
					<img class="col-xs-12 col-md-5 col-md-offset-1 imgright" src="images/IMG_7453.JPG">
				...
				<div class="col-sm-4 col-xs-12 hover-img">
					<div class="hovereffect">
						...
						<div class="overlay">
							<h1>VERBOUW</h1>
							<p>
								Bouwbedrijf wegro bv focust zich op uw wensen, maar ook op uw budget en planning.
								Samen met u bepalen we de beste optie om uw huis te verbouwen. Daarnaast adviseren wij u over ontwerp, uitwerking, materialen, planning en prijs.
								We maken duidelijk afspraken over de uitvoering van uw verbouwing, en of het nu om een grote of kleine verbouwing gaat: wij nemen u graag alle werk uit handen.
								Van het aanvragen van de bouwvergunning tot en met het opruimen na de werkzaamheden.
							</p>
						</div>
					</div>
				</div>
