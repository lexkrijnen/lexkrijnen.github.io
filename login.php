...
?>
  ...
  <script src="https://www.google.com/recaptcha/api.js" async defer></script>
	...
	<?php
			if (!empty($klant_id)) {
				print('<div class="container"><div class="row"><div class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3 page-box"><h5>Een moment gedult A.U.B.</h5></div></div></div><br>');
