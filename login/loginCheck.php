...
if(isset($_POST['btn-login']))
{
    ...
    if (empty($queryresult)) {
        ...
        print('<div class="container page-box"><div class="col-xs-4 col-md-5"><h5>Gebruikersnaam of wachtwoord is onjuist, je word automatisch teruggestuurd naar de inlogpagina.</h5></div><br>');
